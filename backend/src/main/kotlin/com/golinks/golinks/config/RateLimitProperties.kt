...
class RateLimitProperties {
    ...
    var auth: EndpointLimit = EndpointLimit(maxRequests = 10, windowSeconds = 60)
    ...
    var default: EndpointLimit = EndpointLimit(maxRequests = 60, windowSeconds = 60)

    /** Suspicious client penalty — applied when abuse is detected */
    var suspicious: EndpointLimit = EndpointLimit(maxRequests = 5, windowSeconds = 60)
